...
const Hero = () => {
  return (
    <section
      ...
      style={{
        backgroundImage:
          "url('https://res.cloudinary.com/dluulfzrc/image/upload/v1762493016/banner_kahkom.webp')",
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full mt-2">
          ...
          <Link
            ...
            className="
              ...
              rounded-4xl text-sm sm:text-base shadow-lg cursor-pointer
              w-[250px] sm:w-[210px] tracking-wide
              transition duration-300 hover:bg-black hover:text-white active:bg-[#333333]
            "
          >
            <p className="text-[14px] md:text-[16px]">Take Scholarship Test</p>
          </Link>
        </div>
      </div>
      {/* Bottom Padding */}
