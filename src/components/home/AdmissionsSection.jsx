...
//       h-[465px] min-h-[465px] bg-[#09254a]/80
//       text-white text-center
//       overflow-hidden
//     "
//     style={{
//       backgroundImage: `url(${bannerImage.src})`,
//        // Update based on your public assets folder
//       backgroundSize: 'cover',
//       backgroundPosition: 'center'
//     }}
//   >
//     {/* Overlay for dark effect */}
//     <div className="absolute inset-0 bg-[#09254a] bg-opacity-10" />
    
//     {/* Content */}
//     <div className="relative z-10 flex flex-col items-center justify-center h-full pt-16 sm:pt-24">
...
//           </svg>
//         </span>
//         <span className="text-amber-400 text-xs font-semibold tracking-wide uppercase">ADMISSIONS OPEN</span>
//       </div>
