...
// const ContactUs = () => (
//   <section className="w-full bg-[#fafbfb] py-16 px-2 sm:px-6 lg:px-0 flex items-center justify-center">
//     <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-center w-full gap-8">
      
//       {/* Left: Illustration + Heading + Subtitle */}
//       <div className="w-full lg:w-[48%] flex flex-col items-center lg:items-start text-center lg:text-left mb-10 lg:mb-0">
//         {/* Replace with your actual SVG/PNG */}
//         <Image
//           src="/assets/home/contactform.svg" // Or your real path, e.g., /contact-illustration.png
//           alt="Contact Illustration"
//           width={260}
//           height={210}
//           className="mx-auto mb-8"
//         />
//         <h2 className="font-bold text-3xl sm:text-4xl text-gray-900 mb-4 leading-tight">
//           Have Questions? <br className="hidden sm:block" />
//           We’re Here to Help!
//         </h2>
//         <p className="text-gray-600 text-base font-medium max-w-md">
//           Enquire about admissions or get <br className="hidden sm:block" />
//           answers to your doubts in one step.
//         </p>
//       </div>

//       {/* Right: Form inside Card */}
//       <div className="w-full lg:w-[52%] flex flex-col items-center">
//         <form className="w-full bg-white rounded-2xl shadow-xl border border-gray-100 px-6 py-8 max-w-xl">
//           <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-3">
//             <div>
//               <label className="text-[13px] font-semibold text-gray-800 block mb-1">Parent’s Name</label>
//               <input type="text" placeholder="Enter your full name"
//                 className="w-full border border-gray-200 rounded-md px-3 py-2 text-base outline-none focus:ring-2 focus:ring-[#09254A]/20" />
//             </div>
//             <div>
//               <label className="text-[13px] font-semibold text-gray-800 block mb-1">Child’s Name</label>
//               <input type="text" placeholder="Enter your child’s name"
//                 className="w-full border border-gray-200 rounded-md px-3 py-2 text-base outline-none focus:ring-2 focus:ring-[#09254A]/20" />
//             </div>
//           </div>
//           <div className="mb-3">
//             <label className="text-[13px] font-semibold text-gray-800 block mb-1">Class Interested For</label>
//             <input type="text" placeholder="e.g., Pre-school, Class 5, Class 12"
//               className="w-full border border-gray-200 rounded-md px-3 py-2 text-base outline-none focus:ring-2 focus:ring-[#09254A]/20" />
//           </div>
//           <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-3">
//             <div>
//               <label className="text-[13px] font-semibold text-gray-800 block mb-1">Phone Number</label>
//               <input type="tel" placeholder="Enter your mobile number"
//                 className="w-full border border-gray-200 rounded-md px-3 py-2 text-base outline-none focus:ring-2 focus:ring-[#09254A]/20" />
//             </div>
//             <div>
//               <label className="text-[13px] font-semibold text-gray-800 block mb-1">Email Address <span className="text-gray-400">(optional)</span></label>
//               <input type="email" placeholder="Enter your email address"
//                 className="w-full border border-gray-200 rounded-md px-3 py-2 text-base outline-none focus:ring-2 focus:ring-[#09254A]/20" />
//             </div>
//           </div>
//           <div className="mb-3">
//             <label className="text-[13px] font-semibold text-gray-800 block mb-1">Your Message</label>
//             <textarea
...
//           </div>
//           <div className="mb-5">
//             <label className="text-[13px] font-semibold text-gray-800 block mb-2">Preferred Contact Method</label>
