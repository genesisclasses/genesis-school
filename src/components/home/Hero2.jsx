  ...
  return (
    <div style={{
            ...
            <div className="relative z-10 text-center text-white p-4 max-w-7xl mx-auto">
              ...
              <h1 className="text-5xl tracking-wide text-[48px] font-extrabold mb-3 leading-tight font-kameron">The Genesis School</h1>
              
              {/* Lato: Subtitle (Large Text) */}
              {/* <h2 className="text-xl font-normal tracking-wider mb-6 italic font-lato"></h2> */}
              
              {/* Kameron: Tagline */}
              <h3 className="text-[48px] tracking-wide font-extrabold mb-5 leading-tight font-kameron">
              Excellence in Education, Excellence in Life
              </h3>
              
              {/* Lato: Description (Para) */}
              <p className="max-w-5xl mx-auto text-base mb-8 font-light leading-relaxed px-2 font-lato">
              ...
              <button 
                className="bg-amber-500 text-[#001f3f] font-semibold px-8 py-3 rounded-4xl text-lg hover:bg-amber-400 transition duration-200 shadow-xl font-lato"
              >
                Book Campus Tour
              </button>
            </div></div>
