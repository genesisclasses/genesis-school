        ...
        {mobileOpen && (
          <div className="lg:hidden absolute top-16 left-0 w-full bg-white/80 backdrop-blur-xl shadow-lg">
            <ul className="flex flex-col items-center space-y-4 py-6 text-gray-900 text-base font-medium">
              ...
              <li><Link to="/academics" onClick={() => setMobileOpen(false)}>Academics</Link></li>
              <li><Link to="/darpan" onClick={() => setMobileOpen(false)}>Project DARPAN</Link></li>
              <li><Link to="/campus" onClick={() => setMobileOpen(false)}>Campus Life</Link></li>
              <li>
                <Link
                  to="/visit"
